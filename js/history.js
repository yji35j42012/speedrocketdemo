...
function scrollListener() {
    ...
    if (windowHeight + defaultScore > history_item[showCount].offsetTop + defaultH) {
    ...
    else if (showCount > 0 && history_item[showCount].offsetTop - defaultScore - history_titleH - defaultH - phH > windowHeight) {
